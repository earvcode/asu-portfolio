...
function addImages(){
  var images = ["boy", "flower", "sunset", "boy2", "bison", "falls", "peak"];
  for (i in images){ 
    $("#imageSlide").append('<img src="images/'+ images[i] + '.jpg" />'); }
  $("#imageSlide img").each(function(){ sliderWidth += $(this).width() + 26; });
  sliderWidth += 40; 
...
$(document).ready(function(){
  addImages();
  $("#left").mouseenter(function(){ slide(50); });
  $("#left").mouseleave(function(){ $("#imageSlide").stop(true); return false; });
  $("#right").mouseenter(function(){ slide(-50); });
  $("#right").mouseleave(function(){ $("#imageSlide").stop(true); return false; });
  $("#imageSlide img").mouseenter(function(){ 
    $(this).stop(true).animate({height:120, opacity:1},500); return false; });
  $("#imageSlide img").mouseleave(function(){ 
    $(this).stop(true).animate({height:100, opacity:.5},500); return false; });
